...
let current_users = ["DaNiyal", "ahsan", "umar", "johN", "wick"];
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let new_users = ["moazzam", "fawad", "DaNiyal", "waiz", "johN"];
...
new_users.forEach((n_users) => {
    ...
    if (current_users.map((c_users) => c_users.toLowerCase()).includes(lowercase)) {
        console.log(`The username ${n_users} is not available, select a new username.`);
    }
    else {
